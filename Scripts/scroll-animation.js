var works = [document.querySelector(".work1"), document.querySelector(".work2"), document.querySelector(".work3"), document.querySelector(".work4"), document.querySelector(".work5"), document.querySelector(".work6"),document.querySelector(".work7")];
...
window.addEventListener('scroll', function () {
    ...
    if(scroll > 800 && scroll < 7000){
        ...
        scaleWork(works[6], scroll, 150, 65);
    }
